...
According to the spaghetti plot above, the experimental arm showed a increasing trend in observations over 8 weeks, but the control arm did not show any obvious trend. Except week 1, the observations of experimental arm did not have values below 0. However, several observations of control arm have values below 0.
